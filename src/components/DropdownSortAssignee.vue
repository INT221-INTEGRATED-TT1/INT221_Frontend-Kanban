...
<template>
  <div class="flex gap-x-3 items-center">
    <div class="itbkk-asssignees-sort dropdown">
      <div
        tabindex="0"
        role="button"
        class="flex gap-x-3 justify-center items-center"
      >
        <AssigneesIcon />Assignees <dropdownSort />
      </div>
      <ul
        tabindex="0"
      ...
      >
        <li
          class="p-0"
          @click="
            sortAndFilterStore.filterOrSortByStatus('ASC', 'assignees', '', '')
          "
          :class="{
        ...
        >
          <span
            ...
            <SelectedDot
              v-show="
                sortAndFilterStore.selectedOption === 'ASC' ? true : false
              "
            />
          </span>
        </li>
        <li
          class="p-0"
          @click="
            sortAndFilterStore.filterOrSortByStatus('DESC', 'assignees', '', '')
          "
          :class="{
        ...
        >
          <span
            ...
            <SelectedDot
              v-show="
                sortAndFilterStore.selectedOption === 'DESC' ? true : false
              "
            />
          </span>
        </li>
