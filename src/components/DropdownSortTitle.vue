...
<template>
  <div class="flex gap-x-3 items-center text-center">
    <div class="itbkk-title-sort dropdown">
      <div
        tabindex="0"
        role="button"
        class="flex gap-x-3 justify-center items-center"
      >
        <TitleIcon />Title <dropdownSort />
      </div>
      <ul
        tabindex="0"
      ...
      >
        <li
          class="p-0"
          @click="
            sortAndFilterStore.filterOrSortByStatus('ASC', 'title', '', '')
          "
          :class="{
        ...
        <li
          class="p-0"
          @click="
            sortAndFilterStore.filterOrSortByStatus('DESC', 'title', '', '')
          "
          :class="{
